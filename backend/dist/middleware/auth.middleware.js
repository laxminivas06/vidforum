...
async function authMiddleware(req, res, next) {
    ...
    if (!authHeader || !authHeader.startsWith('Bearer ')) {
        ...
        const devInstId = req.headers['x-institution-id'] || '22222222-2222-2222-2222-222222222201';
        if (devUserId || process.env.NODE_ENV === 'development') {
            try {
                const userId = devUserId || '44444444-4444-4444-4444-444444444401';
                const profileRes = await database_1.db.query(`SELECT p.id, p.full_name, p.email, p.default_institution_id,
        ...
        (0, api_response_1.sendError)(res, 'Authentication token missing or invalid', 401, 'UNAUTHORIZED');
        return;
    }
    ...
    try {
        ...
        (0, api_response_1.sendError)(res, 'Invalid or expired token', 401, 'INVALID_TOKEN');
    }
}
